...
- Keep the 3A namespaces (`RT-HEADERS-*`, `RT-COOKIE-*`, `RT-CORS-*`, `RT-REDIRECT-*`, `RT-TLS-*`, `RT-ERROR-*`)
  separate from the 3B namespaces (`RT-AUTH-*`, `RT-SESSION-*`), the reserved 3C namespace (`RT-AUTHZ-*`, never
  generated by this version) and ZAP baseline findings (`RT-ZAP-*`).
...
- These areas remain part of the **Layer 2 source-code review** until runtime checks are separately implemented or
  their results imported. `RT-AUTHZ-*` is reserved for such results; this version generates none, and a
  NOT VERIFIED status is a coverage gap, not a finding.
...
- Findings keep their IDs and sources (`P2-*`, `AI-*`, `RT-*`, `RT-ZAP-*`, `RT-AUTH-*`, `RT-SESSION-*`, `RT-AUTHZ-*`), severity is
...
executed; covered only by Layer 2 source-code review"). `RT-AUTHZ-*` findings only if imported from a separate tool;
none are generated by this version.
